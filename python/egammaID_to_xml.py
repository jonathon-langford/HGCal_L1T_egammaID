...
egID_model.load_model( "%segID_%s.model"%(modelDir,modelAlgo) )
print "  --> Loaded model: egID_%s.model"%modelAlgo

# Define name of xml file to save
f_xml = "%segID_%s.xml"%(modelDir,modelAlgo)


#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# Convert to xml
from mlglue.tree import tree_to_tmva, BDTxgboost, BDTsklearn
target_names = ['eg_background_PU','eg_signal']
